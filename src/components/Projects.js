        ...
        <div>
          <div className="post">
            ...
            <div className="post-preview">
              ...
              <p className="post-intro">
                The Covid-19 crisis has affected us all. I built a simple
                website to showcase the numbers of people affected by this virus
                (infected, recovered and deceased) - the data is from an API and
                updated daily. Technologies used: REACT.js , Chart.js, HTML,
                CSS.{" "}
              </p>
